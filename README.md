# Laravel Shopping Cart (Laravel 5 - 13)
[![Build Status](https://github.com/robertnicjoo/laravel-shopping-cart/actions/workflows/tests.yml/badge.svg)](https://github.com/robertnicjoo/laravel-shopping-cart/actions)
[![Total Downloads](https://poser.pugx.org/nicxonsolutions/laravel-shopping-cart/d/total.svg)](https://packagist.org/packages/nicxonsolutions/laravel-shopping-cart)
[![License](https://poser.pugx.org/nicxonsolutions/laravel-shopping-cart/license.svg)](https://packagist.org/packages/nicxonsolutions/laravel-shopping-cart)

A robust Shopping Cart implementation for Laravel Framework, now supporting Laravel 13.
...
```php
Nicxonsolutions\Cart\CartServiceProvider::class
```

2. Open config/app.php and add this line to your Aliases

```php
  'Cart' => Nicxonsolutions\Cart\Facades\CartFacade::class
```

3. Optional configuration file (useful if you plan to have full control)

```php
php artisan vendor:publish --provider="Nicxonsolutions\Cart\CartServiceProvider" --tag="config"
```
...
$condition = new \Nicxonsolutions\Cart\CartCondition(array(
    'name' => 'VAT 12.5%',
    'type' => 'tax',
...
$condition1 = new \Nicxonsolutions\Cart\CartCondition(array(
    'name' => 'VAT 12.5%',
    'type' => 'tax',
    'target' => 'subtotal', // this condition will be applied to cart's subtotal when getSubTotal() is called.
    'value' => '12.5%',
...
$condition2 = new \Nicxonsolutions\Cart\CartCondition(array(
...
$saleCondition = new \Nicxonsolutions\Cart\CartCondition(array(
            'name' => 'SALE 5%',
            'type' => 'tax',
            'value' => '-5%',
        ));
...
$itemCondition1 = new \Nicxonsolutions\Cart\CartCondition(array(
    'name' => 'SALE 5%',
    'type' => 'sale',
    'value' => '-5%',
));
...
$itemCondition3 = new \Nicxonsolutions\Cart\CartCondition(array(
    'name' => 'MISC',
    'type' => 'misc',
    'value' => '+10',
));
...
this demo repo here: [DEMO](https://github.com/nicxonsolutions/laravelshoppingcart-demo)
...
use Carbon\Carbon;
use Cookie;
use Nicxonsolutions\Cart\CartCollection;
...
[See Demo App Here](https://shoppingcart-demo.nicxonsolutions.com/cart)

OR

[See Demo App Repo Here](https://github.com/robertnicjoo/laravelshoppingcart-demo)

## Support / Sponsor

If you find this package useful and would like to support its development, please consider sponsoring:

- **GitHub Sponsors**: [robertnicjoo](https://github.com/sponsors/robertnicjoo)
- **Buy Me A Coffee**: [robertnicjoo](https://www.buymeacoffee.com/robertnicjoo)
- **PayPal**: [paypal.me/rnicjoo](https://paypal.me/rnicjoo)

## License

The Laravel Shopping Cart is open-sourced software licensed under the [MIT license](LICENSE).
